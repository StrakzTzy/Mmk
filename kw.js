...
*BOT WHATSAPP BY Strakz-MD ✨*

      *⏤͟͟͞͞★ INFO - BOT ꗄ➺* 

*☍ Nama BOTz :* StrakzBotz-MD
*☍ Version BOTz :* v8.0.0
...
- 𝙎𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚 𝙔𝙤𝙪𝙩𝙪𝙗𝙚
youtube.com/@strakzstore

⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕
          『 *© Strakz-Cmd* 』

*_© StrakzBotz-MD  || BY Strakz_*`
client.sendMessage(from, { image: thumb, caption: ngen, mentions:[sender, owned] }, { quoted: msg })
}
break
case "formatpost": {
teks938 = `*FORMAT JASA POST STRAKZ STORE !*  
( BUKAN MILIK ADMIN )
...
break
case "payment": {
teks137 = "*🔰PAYMENT STRAKZ STORE*\n```SEMUA PEMBAYARAN\nWAJIB MENYERTAKAN BUKTI TRANSFER !!```\n*_( ALL TRX NO REFF‼️ )_*\n\n*• GOPAY 💳 :* _082125214084_\n```( ATAS NAMA: STRAKZ STORE )```\n\n*• DANA 💳 :*```_\n( ATAS NAMA: - )```\n\n*• OVO 💳 :*```_\n( ATAS NAMA:  )```\n\n*• SHOPPE PAY 💳 :*```_\n( ATAS NAMA:  )```\n\n*• QRIS 💳 :*_https://i.ibb.co/yBJhBRy/SCAN-BARCODE-TERSEBUT-UNTUK-PEMBAYARAN.jpg_\n```( ATAS NAMA: ALLPAY 15 )```\n\n*© Strakz-MD OFFICIAL ⚡*"
reply(teks137)
}
break
case "donasi": {
...
⏣ ɢᴏᴘᴀʏ: [ 082125214084 ]
⏣ ᴛᴇʟᴋᴏᴍsᴇʟ:  [ - ]
⏣ ǫʀɪs ᴀʟʟ ᴘᴀʏ : [ https://i.ibb.co/yBJhBRy/SCAN-BARCODE-TERSEBUT-UNTUK-PEMBAYARAN.jpg ]
...
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/62881024760837`
