...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Strakz-MD", "Dekstop", "3.0"]})
console.log(color('[ SC BY StrakzMD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : Strakz-MD\n➸ Creator : ZIRO\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : strakzstore`\n➸ My Instagram : @pragoszs\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/ZD\n\nThanks\n', 'red'))
...
sendMessage(`62881024760837@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
