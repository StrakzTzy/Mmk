...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC StrakzStore", "Dekstop", "3.0"]})
console.log(color('[ SC BY StrakzBotz ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : StrakzPrivate\n➸ Creator : Strakz\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : STRAKZ STORE`\n➸ My Instagram : @pragoszs\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/ZiD\n\nThanks\n', 'red'))
